...
mat_Scale = glm::scale(glm::mat4(1.0f), glm::vec3(2.f, 1.f, 1.5f)); 
mat_LookAt = glm::lookAt(glm::vec3(0, 0, -5.f), glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.f, 1.f, 0.f)); 
mat_Ortho = glm::ortho(1.f, -1.f, 1.f, -1.f, 1.f, -1.f); 
mat_Frustum = glm::frustum(-0.1f, 0.1f, -0.1f, 0.1f, 0.1f, 1000.f); 
mat_Perspective = glm::perspective(glm::radians(60.f), 1.0f, 0.001f, 10000.f); 
